<script lang="ts">
	import logo from '$lib/assets/images/footer_logo.png';
</script>
		...
		<div class="xs-footer-top-layer">
			<div class="row">
				<div class="col-lg-3 col-md-6 footer-widget xs-pr-20">
					...
					<p>
						CharityPress online and raise money for charity and causes you’re passionate about.
				...
				<div class="col-lg-4 col-md-6 footer-widget">
					...
					<ul class="xs-info-list">
						<li>
							<i class="fa fa-home"></i>Sector # 48, 123 Street, miosya road VIC 28, Australia.
						</li>
						<li><i class="fa fa-phone"></i>(800) 123.456.7890 (800) 123.456.7890 +00 99 88 5647</li>
						<li>
							<i class="fa fa-envelope-o"></i><a href="mailto:yourname@domain.com"
