<script lang="ts">
	...
	import about_bg from '$lib/assets/images/about_bg.png';
</script>

<svelte:head>
	<title>About Us | Charity</title>
</svelte:head>	
...
<section
	...
	style="background-image:url({about_bg})"
>
		...
		<div class="color-white xs-inner-banner-content">
			...
			<ul class="xs-breadcumb">
				<li class="badge badge-pill badge-primary">
					<a href="/" class="color-white"> Home /</a> About
				</li>
			</ul>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-lg-8 content-center">
					<div class="xs-video-popup-wraper">
						<img src="src/lib/assets/images/video_img.jpg" alt="" />
				...
				<div class="col-lg-11 content-center">
					<div class="xs-heading xs-mb-100 text-center">
						<h2 class="xs-mb-0 xs-title">
							We are an Globian non-profit organization that <span class="color-green"
								>supports</span
			...
			<div class="row">
				<div class="col-md-4">
					<div class="xs-about-feature">
						<h3>Our Mission</h3>
						<p class="lead">
							The CharityPress community was named a “Top 25 Best Global Philanthropist” by
							Barron’s. We beat Oprah. And, Mashable named CharityPress something like that.
						</p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="xs-about-feature">
						<h3>Our Vission</h3>
						<p class="lead">
							The Globian Fund for Charities seeks positive change around the world through support
							of non-profit organizations dedicated to social, cultural.
						</p>
					</div>
				</div>
				<div class="col-md-4">
		...
		<div class="container">
			<div class="xs-heading row xs-mb-60">
				<div class="col-md-9 col-xl-9">
					...
					<p>
						It allows you to gather monthly subscriptions from fans to help fund your creative
						projects. They also encourage their users to offer rewards to fans as a way to repay
			...
			<div class="row">
				<div class="col-md-6 col-lg-3">
					<div class="xs-service-promo">
						...
						<p>
							663 million people drink dirty water. Learn how access to clean water can improve
							health, boost local economies.
						</p>
					</div>
				</div>
				<div class="col-md-6 col-lg-3">
